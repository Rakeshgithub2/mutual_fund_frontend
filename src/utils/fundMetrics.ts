...
function calculateSharpeRatio(
  ...
  standardDeviation: number,
  riskFreeRate: number = 6.5 // India's current approximate risk-free rate
): number {
 ...
 * Simplified calculation: uses volatility as proxy for beta
 */
function calculateBeta(
  fundVolatility: number,
  benchmarkVolatility: number = 15 // Average market volatility
): number {
...
function calculateAlpha(
  ...
  marketReturn: number = 12 // Average market return
): number {
...
export function calculateRiskMetrics(
  ...
  // Calculate Sharpe Ratio using 1Y return
...
export function determineRiskLevel(
  ...
  // Equity funds typically have higher volatility
  ...
  // Debt funds have lower volatility
